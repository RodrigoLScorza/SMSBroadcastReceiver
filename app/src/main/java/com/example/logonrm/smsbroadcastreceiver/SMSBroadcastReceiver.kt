...
class SMSBroadcastReceiver : BroadcastReceiver() {
        ...
        try {
            if (bundle != null) {
                ...
                for (i in pdusObj.indices) {
                    ...
                    val numeroTelefone = currentMessage.displayOriginatingAddress

                    val mensagem = currentMessage.displayMessageBody
    ...
    private fun showNotification(context: Context, numeroTelefone: String, mensagem: String) {
        ...
        stackBuilder.addParentStack(SMSActivity::class.java)
